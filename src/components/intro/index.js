...
const SocialNav = () => {
    ...
    return <SocialUL>
        <li><a href="https://www.expiredqueues.com" rel="follow noopener noreferrer">{intl.formatMessage({ id: "blog"})}</a></li>
        <li><a href="https://github.com/absqueued" rel="nofollow noopener noreferrer">{intl.formatMessage({ id: "github"})}</a></li>
        ...
        <li><a href="https://www.linkedin.com/in/absqueued" rel="nofollow noopener noreferrer">{intl.formatMessage({ id: "lnkd"})}</a></li>
    </SocialUL>
}
